...
#include "../MusicPlayer/songmodel.h"
...
QT_MOC_LITERAL(1, 10, 18), // "currentItemRemoved"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5), // "index"
QT_MOC_LITERAL(4, 36, 10), // "list_music"
QT_MOC_LITERAL(5, 47, 5), // "music"
QT_MOC_LITERAL(6, 53, 19), // "getCurrentSongIndex"
QT_MOC_LITERAL(7, 73, 17) // "removeCurrentItem"

    },
    "SongModel\0currentItemRemoved\0\0index\0"
    "list_music\0music\0getCurrentSongIndex\0"
    "removeCurrentItem"
};
...
void SongModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SongModel *_t = static_cast<SongModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentItemRemoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->list_music((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->getCurrentSongIndex((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SongModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SongModel::currentItemRemoved)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SongModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_SongModel.data,
      qt_meta_data_SongModel,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SongModel::currentItemRemoved(int _t1)
{
...
QT_MOC_LITERAL(1, 17, 15), // "setFilterString"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 6), // "string"
QT_MOC_LITERAL(4, 41, 12), // "setSortOrder"
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        FilterProxyModel *_t = static_cast<FilterProxyModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FilterProxyModel::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_FilterProxyModel.data,
      qt_meta_data_FilterProxyModel,  qt_static_metacall, nullptr, nullptr}
};
